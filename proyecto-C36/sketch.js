...
function setup(){
    ...
    //Código para el suelo café
    var ground_options ={
        isStatic: true, 
    }

    ground = Bodies.rectangle(400,390,400,10,ground_options);
    World.add(myworld,ground);


    // Código para la caja roja
    var redBox_options ={
        isStatic: true,
    }

    redBox = Bodies.rectangle(270,320,50,10,redBox_options);
    World.add(myworld,redBox);

    // Código para la caja verde
    ...
    // Código para la pelota
    var ball_options ={
        //Escribe un código para agregar restitución a la pelota
     ...
     //Escribe el código de abajo para añadir el objeto de la pelota al mundo
     World.add(myworld,ball);
    
    //Escribe el código sobre esta línea
